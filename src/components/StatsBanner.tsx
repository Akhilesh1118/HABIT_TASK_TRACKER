  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3 mb-6">
      ...
      <div
        ...
        className={`bg-white rounded-xl p-3.5 border shadow-xs flex flex-col justify-between transition-colors ${
      ...
      >
        <div className="flex items-center justify-between text-stone-500 mb-1">
          <span className="text-xs font-semibold uppercase tracking-wider text-emerald-800">Productivity</span>
          <TrendingUp className="w-4 h-4 text-emerald-600" />
        </div>
        <div className="flex items-baseline space-x-1.5">
          <span className="text-2xl font-extrabold text-stone-900">{productivityScore}%</span>
      ...
      >
        <div className="flex items-center justify-between text-stone-500 mb-1">
          <span className="text-xs font-medium uppercase tracking-wider text-emerald-800">Focus Today</span>
        ...
        <div className="flex items-baseline space-x-1">
          ...
          <span className="text-xs text-stone-500">logged</span>
        </div>
      </div>
      ...
      <div
        ...
        className={`rounded-xl p-3.5 border shadow-xs flex flex-col justify-between transition-all cursor-pointer group hover:shadow-md ${
          isAtRisk
      ...
      >
        <div className="flex items-center justify-between text-stone-500 mb-1">
          <span className="text-xs font-medium uppercase tracking-wider group-hover:text-stone-900 transition-colors">
            Streak
          </span>
        ...
        <div className="flex items-baseline justify-between">
          <div className="flex items-baseline space-x-1">
            <span className={`text-2xl font-bold ${isAtRisk ? 'text-amber-950' : isFrozen ? 'text-sky-950' : 'text-stone-900'}`}>
              {stats.currentStreak}
            </span>
        ...
        {isAtRisk && (
          <div className="mt-1 text-[10px] font-bold text-amber-800 flex items-center space-x-1">
            <span>⚠️ Streak at risk</span>
          </div>
        )}
        {isFrozen && (
          <div className="mt-1 text-[10px] font-bold text-sky-800 flex items-center space-x-1">
      ...
      <div
        ...
        className="bg-white rounded-xl p-3.5 border border-stone-200/80 shadow-xs flex flex-col justify-between"
      >
        <div className="flex items-center justify-between text-stone-500 mb-1">
          <span className="text-xs font-medium uppercase tracking-wider">Done Today</span>
          <CheckCircle className="w-4 h-4 text-emerald-600" />
        </div>
        <div className="flex items-baseline space-x-1">
          <span className="text-2xl font-bold text-stone-900">{stats.completedToday}</span>
      ...
      >
        <div className="flex items-center justify-between text-stone-500 mb-1">
          <span className="text-xs font-medium uppercase tracking-wider text-indigo-900">This Week</span>
          <Calendar className="w-4 h-4 text-indigo-600" />
        </div>
        <div className="flex items-baseline space-x-1">
          <span className="text-2xl font-bold text-stone-900">{stats.completedThisWeek}</span>
          <span className="text-xs text-stone-500">items</span>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex items-baseline space-x-1">
          <span className="text-2xl font-bold text-stone-900">{stats.longestStreak}</span>
          <span className="text-xs text-stone-500">days</span>
        </div>
      </div>
      ...
      <div
        id="stat-top-habit"
        className="bg-white rounded-xl p-3.5 border border-stone-200/80 shadow-xs flex flex-col justify-between col-span-2 sm:col-span-1 lg:col-span-1"
      >
        <div className="flex items-center justify-between text-stone-500 mb-1">
          <span className="text-xs font-medium uppercase tracking-wider truncate">Top Habit</span>
          <Award className="w-4 h-4 text-purple-500 shrink-0" />
        </div>
        {stats.mostConsistentHabit ? (
          <div className="truncate">
            <p className="text-xs font-semibold text-stone-800 truncate" title={stats.mostConsistentHabit.name}>
